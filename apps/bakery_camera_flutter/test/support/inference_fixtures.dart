...
InferenceResult buildUiInferenceResult({
  ...
  'objects': [
    ...
    if (includeUnchangedRegisteredObject)
      buildInferenceObjectJson(
        id: 'object-3',
        skuId: 6,
        name: 'Croissant',
        confidence: 0.89,
        decisionPath: 'repvit_direct',
        box: [1100.0, 100.0, 1500.0, 600.0],
      ),
  ],
  'counts': {'6': includeUnchangedRegisteredObject ? 2 : 1},
  'unknown_count': 1,
  'presentation':
      presentation ??
...
List<Map<String, Object?>> candidateJson({required double topScore}) => [
  ...
  {'rank': 2, 'sku_id': 11, 'sku_name': 'Cream Donut', 'score': topScore / 2},
  {'rank': 3, 'sku_id': 12, 'sku_name': 'Glazed Donut', 'score': topScore / 4},
];
